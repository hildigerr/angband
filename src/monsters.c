...
{"Shrieker mushroom patch"  ,(MV_ONLY_ATT),(NONE8)
                            ,(IM_POISON|CHARM_SLEEP|ANIMAL|MINDLESS),(NONE8),(NONE8)
...
{"White jelly"		    ,(MV_ONLY_ATT),(NONE8)
			    ,(CHARM_SLEEP|ANIMAL|HURT_LIGHT|IM_POISON|MINDLESS),
                            (NONE8)
...
{"Green ooze"		    ,(HAS_90|CARRY_GOLD|CARRY_OBJ|MV_75|MV_ATT_NORM)
                            ,(NONE8),(CHARM_SLEEP|ANIMAL|IM_ACID|IM_POISON|MINDLESS)
			    ,(NONE8),(NONE8)
...
{"Blue jelly"		    ,(MV_ONLY_ATT),(NONE8),(CHARM_SLEEP|ANIMAL|
                             HURT_LIGHT|IM_FROST|NO_INFRA|MINDLESS)
			    ,(NONE8),(NONE8)
...
{"Blue ooze"		    ,(HAS_60|CARRY_GOLD|CARRY_OBJ|MV_75|MV_ATT_NORM)
                            ,(NONE8),(CHARM_SLEEP|ANIMAL|IM_FROST|MINDLESS), (NONE8)
...
{"Brown mold"		    ,(MV_ONLY_ATT),(NONE8),(IM_POISON|CHARM_SLEEP|ANIMAL|MINDLESS)
			    ,(NONE8),(NONE8)
...
{"Red jelly"		    ,(MV_ONLY_ATT),(NONE8)
			    ,(CHARM_SLEEP|ANIMAL|HURT_LIGHT|MINDLESS),(NONE8),
...
{"Green icky thing"	    ,(MV_ATT_NORM|MV_40),(NONE8),(ANIMAL|IM_ACID),(NONE8)
			   ,(NONE8),18,20,14,12,11,'i',{5,8},{137,0,0,0},7,2,'n'},

{"Zombie kobold"	    ,(THRO_DR|MV_ATT_NORM),(NONE8),
			     (CHARM_SLEEP|UNDEAD|EVIL|IM_FROST|NO_INFRA|MINDLESS|
			     IM_POISON),(NONE8),(NONE8)
...
{"Hairy mold"		   ,(MV_ONLY_ATT),(NONE8),(ANIMAL|CHARM_SLEEP|MINDLESS|IM_POISON),
                          (NONE8)
			 ,(NONE8),32,70,2,15,11,'m',{15,8},{151,0,0,0},10,2,'n'},

{"Disenchanter mold"	    ,(MV_ONLY_ATT),(MANA_DRAIN|0xBL)
			    ,(ANIMAL|CHARM_SLEEP|MINDLESS|IM_POISON),(NONE8),(NONE8)
...
{"Orc zombie"		    ,(THRO_DR|MV_ATT_NORM),(NONE8)
			    ,(CHARM_SLEEP|EVIL|UNDEAD|ORC|IM_FROST|NO_INFRA|
			     IM_POISON|MINDLESS),(NONE8),(NONE8)
...
{"Magic mushroom patch"	    ,(MV_ONLY_ATT),(0x1L|BLINK|FEAR|SLOW)
			    ,(ANIMAL|GROUP|CHARM_SLEEP|MINDLESS),(DARKNESS),(NONE8)
...
{"Clay golem"		    ,(MV_ATT_NORM),(NONE8),
			     (HURT_ROCK|IM_FIRE|IM_LIGHTNING|IM_FROST|MINDLESS|
...
{"Fire spirit"		    ,(MV_ATT_NORM|MV_20),
			     (NONE8),(EVIL|IM_POISON|IM_FIRE|CHARM_SLEEP|MINDLESS)
			    ,(NONE8),(NONE8)
...
{"Shambling mound"	    ,(MV_ATT_NORM|THRO_DR|CARRY_GOLD|HAS_90)
			    ,(NONE8),(CHARM_SLEEP|ANIMAL|EVIL|MINDLESS),(NONE8)
                            ,(NONE8)
...
{"Stone golem"		    ,(MV_ATT_NORM),(NONE8),(HURT_ROCK|IM_FIRE|
			     IM_FROST|IM_LIGHTNING|IM_POISON|CHARM_SLEEP|MINDLESS|
			     NO_INFRA),(NONE8),(NONE8)
			    ,100,10,12,75,10,'g',{28,8},{9,9,0,0},19,2,'n'},

{"Red mold"		    ,(MV_ONLY_ATT),(NONE8)
                            ,(IM_FIRE|IM_POISON|ANIMAL|MINDLESS)
			    ,(NONE8),(NONE8)
...
{"Quylthulg"		    ,(MV_INVIS),(0x4L|BLINK|MONSTER),(CHARM_SLEEP|MINDLESS)
			    ,(NONE8),(NONE8)
...
{"Iron golem"		    ,(MV_ATT_NORM),(SLOW|0x7L)
			    ,(IM_FIRE|IM_FROST|IM_LIGHTNING|IM_POISON|MINDLESS|
...
{"Mummified human"	    ,(MV_ATT_NORM|THRO_DR|CARRY_OBJ|HAS_90)
			    ,(NONE8),(EVIL|NO_INFRA|UNDEAD|IM_FROST|MINDLESS|
			     IM_POISON|CHARM_SLEEP),(NONE8),(NONE8)
...
{"Mimic"                    ,(MV_ONLY_ATT),(0x4L|FEAR|CONFUSION|BLINDNESS|
			     ...
			     MONSTER),(CHARM_SLEEP|NO_INFRA|MINDLESS),
...
{"Nexus quylthulg"	    ,(MV_INVIS),(0x1L|BLINK),(CHARM_SLEEP|MINDLESS)
			    ,(TELE_AWAY),(NONE8)
...
{"Memory moss"              ,(MV_ONLY_ATT),(0x6L),(CHARM_SLEEP|ANIMAL|MINDLESS)
                            ,(FORGET),(NONE8)
...
{"Giant skeleton troll"	    ,(MV_ATT_NORM|THRO_DR),(NONE8)
			    ,(TROLL|EVIL|UNDEAD|IM_FROST|IM_POISON|MINDLESS|
...
{"Earth elemental"	    ,(THRO_WALL|PICK_UP|MV_ATT_NORM)
			    ,(0x8L|ACID_BOLT)
			    ,(IM_POISON|IM_FIRE|IM_FROST|IM_LIGHTNING|MINDLESS|
...
{"Air elemental"	    ,(MV_ATT_NORM|MV_20|THRO_CREAT),(0x8L)
			    ,(EVIL|IM_POISON|CHARM_SLEEP|IM_FIRE|IM_FROST|MINDLESS|
...
{"Colossus"		    ,(MV_ATT_NORM),(NONE8),(MAX_HP|CHARM_SLEEP|MINDLESS|
...
{"Ice elemental"	    ,(PICK_UP|MV_ATT_NORM)
			    ,(0x5L|FROST_BALL)
			    ,(IM_POISON|IM_FROST|IM_LIGHTNING|MINDLESS|
...
{"Mummified troll"	    ,(HAS_60|CARRY_GOLD|CARRY_OBJ|
			    ...
			    ,(UNDEAD|IM_FROST|CHARM_SLEEP|IM_POISON|MINDLESS|
...
{"Magma elemental"	    ,(THRO_WALL|PICK_UP|MV_ATT_NORM)
			    ,(0x7L|FIRE_BALL)
			    ,(IM_POISON|IM_FIRE|IM_LIGHTNING|MINDLESS|
...
{"Nexus vortex"		    ,(MV_ATT_NORM|MV_75),(0x6L)
			    ,(CHARM_SLEEP|MINDLESS),(BREATH_NE),(NONE8)
			    ,800,0,100,40,12,'v',{32,10},{244,0,0,0},37,1,'n'},

{"Plasma vortex"	    ,(MV_ATT_NORM|MV_75),(0x6L)
			    ,(IM_FIRE|CHARM_SLEEP|MINDLESS),(NONE8),(BREATH_PL)
...
{"Rotting quylthulg"	    ,(MV_INVIS)
			    ,(0x2L|S_UNDEAD|BLINK|TELE), (ANIMAL|EVIL|MAX_HP|
			     CHARM_SLEEP|MINDLESS),(NONE8),(NONE8)
...
{"Death mold"		    ,(MV_ONLY_ATT),(NONE8),(IM_FIRE|IM_POISON|MINDLESS|
...
{"Demonic quylthulg"	    ,(MV_INVIS),(0x2L|S_DEMON|BLINK|TELE)
			    ,(MAX_HP|CHARM_SLEEP|ANIMAL|EVIL|MINDLESS)
                            ,(NONE8),(NONE8)
...
{"Hand druj"		,(MV_ONLY_ATT)
			...
			,(EVIL|NO_INFRA|IM_FROST|CHARM_SLEEP|MAX_HP|UNDEAD
			  |INTELLIGENT|IM_POISON|MINDLESS)
...
{"Eye druj"		,(MV_ONLY_ATT)
			...
			,(EVIL|UNDEAD|CHARM_SLEEP|NO_INFRA|MAX_HP|IM_FROST
			  |IM_POISON|IM_FIRE|INTELLIGENT|MINDLESS)
...
{"Chaos vortex"		     ,(MV_ATT_NORM|MV_75),(0x6L)
			    ,(CHARM_SLEEP|MINDLESS),(BREATH_CH),(NONE8)
...
{"Draconic quylthulg"	     ,(MV_INVIS)
			    ,(0x2L|S_DRAGON|BLINK|TELE),(MAX_HP|ANIMAL|EVIL|MINDLESS
			     |CHARM_SLEEP),(NONE8),(NONE8)
...
{"Cantoras, the Skeletal Lord",
			...
			|MINDLESS|IM_POISON|IM_FIRE|MAX_HP|INTELLIGENT|SPECIAL)
...
struct monster_attack monster_attacks[MAX_A_IDX] = {
