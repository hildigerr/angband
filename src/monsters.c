...
{"Scrawny cat"              ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL),(NONE8)
                            ,(NONE8)
			    ,0,10,30,1,11,'f',{1,2},{49,0,0,0},0,3,'n'},

{"Scruffy little dog"       ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL),(NONE8)
                            ,(NONE8)
...
{"Grey mold"		   ,(MV_ONLY_ATT),(NONE8),(MF2_IM_POIS|MF2_CHARM_SLEEP|
						   MF2_ANIMAL|MF2_MINDLESS),(NONE8)
			   ,(NONE8),3,0,2,1,11,'m',{1,2},{3,3,0,0},1,1,'n'},

{"Grey mushroom patch"	   ,(MV_ONLY_ATT),(NONE8),(MF2_IM_POIS|MF2_CHARM_SLEEP|
						   MF2_ANIMAL|MF2_MINDLESS),(NONE8)
			   ,(NONE8),1,0,2,1,11,',',{1,2},{91,0,0,0},1,1,'n'},

{"Giant yellow centipede"   ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
			    ,2,30,8,12,11,'c',{2,6},{26,60,0,0},1,1,'n'},

{"Giant white centipede"    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL),(NONE8)
			    ,(NONE8),2,40,7,10,11,'c',{3,5},{25,59,0,0},1,1,'n'},

{"White icky thing"	    ,(MV_ATT_NORM|MV_75),(NONE8),(MF2_ANIMAL),(NONE8)
			    ,(NONE8),2,10,12,7,11,'i',{3,5},{63,0,0,0},1,1,'n'},

{"Clear icky thing"	    ,(MV_ATT_NORM|MV_75|MV_INVIS),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,1,10,12,6,11,'i',{2,5},{63,0,0,0},1,1,'n'},

{"Giant white mouse"	    ,(MV_ATT_NORM|MV_40|MULTIPLY),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,1,20,8,4,11,'r',{1,3},{25,0,0,0},1,1,'n'},

{"Large brown snake"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,3,99,4,35,10,'R',{4,6},{26,73,0,0},1,1,'n'},

{"Large white snake"	    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,2,99,4,30,11,'R',{3,6},{24,0,0,0},1,1,'n'},

{"Small kobold"		    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|
			     THRO_DR|MV_ATT_NORM),(NONE8),(MF2_EVIL|MF2_IM_POIS)
			    ,(NONE8),(NONE8)
...
{"Floating eye"		    ,(MV_ONLY_ATT),(NONE8),(MF2_ANIMAL|MF2_HURT_LITE)
			    ,(NONE8),(NONE8)
			    ,1,10,2,6,11,'e',{3,6},{146,0,0,0},1,1,'n'},

{"Rock lizard"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
			    ,2,15,20,4,11,'R',{3,4},{24,0,0,0},1,1,'n'},

{"Jackal"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_GROUP)
			    ,(NONE8),(NONE8)
			    ,1,10,10,3,11,'C',{1,4},{24,0,0,0},1,1,'n'},

{"Soldier ant"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
			    ,3,10,10,3,11,'a',{2,5},{25,0,0,0},1,1,'n'},

{"Fruit bat"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Metallic green centipede" ,(MV_40|MV_ATT_NORM),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
...
{"Novice rogue"		    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|THRO_DR|PICK_UP|
			      MV_ATT_NORM),(NONE8),(MF2_EVIL),(NONE8),(NONE8)
...
{"Giant green frog"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL),(NONE8)
			    ,(NONE8),6,30,12,8,11,'R',{2,8},{26,0,0,0},2,1,'n'},

{"Giant black ant"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL),(NONE8)
			    ,(NONE8),8,80,8,20,11,'a',{3,6},{27,0,0,0},2,1,'n'},

{"Salamander"		    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_IM_FIRE|MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,10,80,8,20,11,'R',{4,6},{105,0,0,0},2,1,'n'},

{"White harpy"		    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL|MF2_EVIL),(NONE8)
			  ,(NONE8),5,10,16,17,11,'H',{2,5},{49,49,25,0},2,1,'f'},

{"Blue yeek"		    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|THRO_DR|
			     MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8)
			    ,(NONE8),4,10,18,14,11,'y',{2,6},{4,0,0,0},2,1,'n'},

{"Grip, Farmer Maggot's dog" ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_UNIQUE|MF2_MAX_HP|
			      MF2_CHARM_SLEEP|MF2_ANIMAL),(NONE8),(NONE8)
			     ,30,0,30,30,12,'C',{5,5},{27,0,0,0},2,1,'n'},

{"Fang, Farmer Maggot's dog" ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_UNIQUE|MF2_MAX_HP|
			      MF2_CHARM_SLEEP|MF2_ANIMAL),(NONE8),(NONE8)
			     ,30,0,30,30,12,'C',{5,5},{27,0,0,0},2,1,'n'},
...
{"Large black snake"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL),(NONE8)
			    ,(NONE8),9,75,5,38,10,'R',{4,8},{27,74,0,0},2,1,'n'},

{"Cave spider"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_GROUP),(NONE8)
			    ,(NONE8),7,80,8,16,12,'S',{2,6},{27,0,0,0},2,1,'n'},

{"Wild cat"                 ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8)
                            ,(NONE8),8,0,40,12,12,'f',{3,5},{51,51,0,0},2,2,'n'},

{"Smeagol"		    ,(HAS_1D2|CARRY_GOLD|HAS_60|THRO_DR|MV_75|
			      MV_ATT_NORM|MV_INVIS),(NONE8),(MF2_EVIL|MF2_UNIQUE)
			    ,(NONE8),(NONE8)
...
{"Black naga"		    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|MV_ATT_NORM|
			      MV_20),(NONE8),(MF2_EVIL),(NONE8),(NONE8)
...
{"Giant white ant"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
			    ,7,80,8,16,11,'a',{3,6},{27,0,0,0},3,1,'n'},

{"Yellow mold"		   ,(MV_ONLY_ATT),(NONE8),(MF2_IM_POIS|MF2_CHARM_SLEEP|
			   MF2_ANIMAL|MF2_MINDLESS),(NONE8),(NONE8)
			   ,9,99,2,10,11,'m',{8,8},{3,0,0,0},3,1,'n'},

{"Metallic red centipede"   ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL),(NONE8)
...
{"Cave lizard"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Blue jelly"		    ,(MV_ONLY_ATT),(NONE8),(MF2_CHARM_SLEEP|MF2_ANIMAL|
...
{"Giant white rat"	    ,(MULTIPLY|MV_20|MV_ATT_NORM),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
...
{"Grey icky thing"	    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL),(NONE8)
...
{"Copperhead snake"	    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL|MF2_IM_POIS)
			    ,(NONE8),(NONE8)
			    ,15,1,6,20,11,'R',{4,6},{158,0,0,0},5,1,'n'},

{"Purple mushroom patch"    ,(MV_ONLY_ATT),(NONE8),(MF2_CHARM_SLEEP|MF2_ANIMAL|MF2_MINDLESS)
			    ,(NONE8),(NONE8)
			    ,15,0,2,1,11,',',{1,1},{183,183,183,0},6,2,'n'},

{"Novice priest"	    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|THRO_DR|
			     MV_ATT_NORM),(0xCL|CAUSE_LIGHT|FEAR),(MF2_GROUP)
			    ,(HEAL),(NONE8)
			    ,7,5,20,10,11,'p',{7,4},{4,0,0,0},6,2,'m'},

{"Novice warrior"	    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|THRO_DR|
			     MV_ATT_NORM),(NONE8),(MF2_GROUP),(NONE8),(NONE8)
			    ,6,5,20,16,11,'p',{9,4},{6,5,0,0},6,2,'m'},

{"Novice rogue"		    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|THRO_DR|
			     MV_ATT_NORM),(NONE8),(MF2_EVIL|MF2_GROUP),(NONE8)
			    ,(NONE8)
			    ,6,5,20,12,11,'p',{8,4},{5,148,0,0},6,2,'m'},

{"Brown mold"		    ,(MV_ONLY_ATT),(NONE8),(MF2_IM_POIS|MF2_CHARM_SLEEP|MF2_ANIMAL|MF2_MINDLESS)
			    ,(NONE8),(NONE8)
			    ,20,99,2,12,11,'m',{15,8},{89,0,0,0},6,1,'n'},

{"Giant brown bat"	    ,(MV_40|MV_20|MV_ATT_NORM),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
...
{"Rattlesnake"		    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL|MF2_IM_POIS)
			    ,(NONE8),(NONE8)
...
{"Wood spider"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_GROUP|MF2_IM_POIS)
			    ,(NONE8),(NONE8)
...
{"Red naga"		    ,(CARRY_GOLD|CARRY_OBJ|HAS_60|MV_ATT_NORM|
			      MV_20|PICK_UP),(NONE8),(MF2_EVIL),(NONE8),(NONE8)
...
{"Giant red frog"	    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL),(NONE8)
			    ,(NONE8),16,50,12,16,11,'R',{5,8},{83,0,0,0},7,1,'n'},

{"Green icky thing"	    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL|MF2_IM_ACID),(NONE8)
...
{"Dark elf"		    ,(CARRY_OBJ|CARRY_GOLD|HAS_90|THRO_DR|
			      MV_ATT_NORM),(0xAL|CONFUSION),(MF2_EVIL|MF2_HURT_LITE)
			    ,(DARKNESS)
			    ,(NONE8),25,20,20,16,11,'h',{7,10},{5,5,0,0},7,2,'m'},

{"Night lizard"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Brown yeek"		    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|THRO_DR|
			      MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
			    ,11,10,18,18,11,'y',{4,8},{5,0,0,0},8,1,'n'},

{"Novice ranger"	    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|THRO_DR|
			     MV_ATT_NORM),(0x9L|MAG_MISS),(MF2_GROUP)
			    ,(NONE8),(NONE8)
...
{"Yeti"			    ,(THRO_DR|MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_IM_COLD)
			    ,(NONE8),(NONE8)
...
{"Black harpy"		    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_EVIL|MF2_ANIMAL)
			    ,(NONE8),(NONE8)
...
{"Baby blue dragon"	    ,(MV_ATT_NORM|HAS_1D2|CARRY_GOLD|HAS_60|THRO_DR)
			    ,(0xBL|BREATH_L),(MF2_IM_ELEC|MF2_EVIL|MF2_DRAGON|
...
{"Baby white dragon"	    ,(MV_ATT_NORM|HAS_1D2|CARRY_GOLD|HAS_60|THRO_DR)
			    ,(0xBL|BREATH_FR),(MF2_IM_COLD|MF2_EVIL|MF2_DRAGON|MF2_MAX_HP)
			    ,(NONE8),(NONE8)
			    ,35,70,20,30,11,'d',{10,10},{51,51,28,0},9,2,'n'},

{"Baby green dragon"	    ,(MV_ATT_NORM|HAS_1D2|CARRY_GOLD|HAS_60|THRO_DR)
			    ,(0xBL|BREATH_G),(MF2_IM_POIS|MF2_EVIL|MF2_DRAGON|MF2_MAX_HP)
			    ,(NONE8),(NONE8)
			    ,35,70,20,30,11,'d',{10,10},{51,51,28,0},9,2,'n'},

{"Baby black dragon"	    ,(MV_ATT_NORM|HAS_1D2|CARRY_GOLD|HAS_60|THRO_DR)
			    ,(0xBL|BREATH_A),(MF2_IM_ACID|MF2_EVIL|MF2_DRAGON|MF2_MAX_HP)
			    ,(NONE8),(NONE8)
			    ,35,70,20,30,11,'d',{10,10},{51,51,28,0},9,2,'n'},

{"Baby red dragon"	    ,(MV_ATT_NORM|HAS_1D2|CARRY_GOLD|HAS_60|THRO_DR)
			    ,(0xBL|BREATH_FI),(MF2_IM_FIRE|MF2_EVIL|MF2_DRAGON|MF2_MAX_HP)
			    ,(NONE8),(NONE8)
			    ,35,70,20,30,11,'d',{10,11},{51,51,28,0},9,2,'n'},

{"Giant red ant"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"King cobra"		    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL|MF2_IM_POIS)
			    ,(NONE8),(NONE8)
			    ,28,1,8,30,11,'R',{8,10},{144,161,0,0},9,2,'n'},

{"Giant spider"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_IM_POIS),(NONE8)
			    ,(NONE8)
...
{"Dark elven warrior"	    ,(CARRY_OBJ|CARRY_GOLD|HAS_1D2|THRO_DR|
			      MV_ATT_NORM),(NONE),(MF2_EVIL|MF2_HURT_LITE)
			    ,(NONE8),(NONE8)
...
{"Giant white tick"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_IM_POIS),(NONE8)
			 ,(NONE8),27,20,12,40,10,'t',{12,8},{160,0,0,0},10,2,'n'},

{"Hairy mold"		   ,(MV_ONLY_ATT),(NONE8),(MF2_ANIMAL|MF2_CHARM_SLEEP|MF2_MINDLESS|MF2_IM_POIS),
                          (NONE8)
...
{"Pseudo dragon"	    ,(MV_ATT_NORM|CARRY_OBJ|CARRY_GOLD|HAS_60)
			    ,(0xBL|FEAR|CONFUSION),(MF2_DRAGON|MF2_MAX_HP)
			    ,(NONE8),(BREATH_LT|BREATH_DA)
			    ,150,40,20,30,11,'d',{22,9},{51,51,28,0},10,2,'n'},

{"Tengu"		    ,(THRO_DR|MV_ATT_NORM)
			    ,(0x3L|BLINK|TELE_TO),(MF2_DEMON|MF2_EVIL|MF2_IM_FIRE),(NONE8)
...
{"Wolf"			  ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL|MF2_GROUP),(NONE8)
			  ,(NONE8),30,20,30,30,12,'C',{6,6},{29,0,0,0},10,1,'n'},

{"Giant fruit fly"	    ,(MULTIPLY|MV_ATT_NORM|MV_75),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,4,10,8,14,12,'F',{2,2},{25,0,0,0},10,6,'n'},

{"Panther"                  ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Hippogriff"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Gnome mage"		    ,(HAS_1D2|CARRY_OBJ|CARRY_GOLD|MV_ATT_NORM|
			     THRO_DR)
			    ,(0x4L|BLINK|FROST_BOLT|MONSTER),(MF2_EVIL)
			    ,(DARKNESS),(NONE8)
			    ,38,10,18,20,11,'h',{7,8},{4,0,0,0},11,2,'m'},

{"Black mamba"		    ,(MV_ATT_NORM|MV_40),(NONE8),(MF2_ANIMAL|MF2_IM_POIS)
			    ,(NONE8),(NONE8)
			    ,40,1,10,32,12,'R',{10,8},{163,0,0,0},12,3,'n'},

{"White wolf"		    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL|MF2_GROUP|
...
{"Master yeek"		    ,(CARRY_GOLD|CARRY_OBJ|HAS_60|THRO_DR|
			     ...
			     BLINDNESS|SLOW),(MF2_ANIMAL|MF2_EVIL),(ST_CLOUD),(NONE8)
...
{"Tiger"                    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Stegocentipede"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Drider"		    ,(MV_ATT_NORM),(0x8L|CAUSE_LIGHT|CONFUSION)
			    ,(MF2_EVIL|MF2_IM_POIS),(DARKNESS),(NONE8)
			    ,55,80,8,30,11,'S',{10,13},{10,10,156,0},13,2,'n'},

{"Killer brown beetle"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Boldor, King of the Yeeks",(CARRY_OBJ|HAS_90|HAS_1D2|THRO_DR|
			     ...
			     BLINDNESS|SLOW),(MF2_MAX_HP|
			     MF2_INTELLIGENT|MF2_ANIMAL|MF2_EVIL|MF2_UNIQUE|MF2_GOOD),(HEAL)
...
{"Illusionist"		    ,(HAS_1D2|CARRY_GOLD|CARRY_OBJ|THRO_DR|
			      ...
			      CONFUSION|SLOW|HOLD_PERSON),(MF2_EVIL|MF2_INTELLIGENT)
...
{"Druid"		    ,(MV_ATT_NORM|CARRY_OBJ|CARRY_GOLD|HAS_1D2|
			     ...
			     SLOW|FIRE_BOLT),(MF2_EVIL|MF2_INTELLIGENT)
...
{"Giant flea"		    ,(MULTIPLY|MV_ATT_NORM|MV_75),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
...
{"Hill giant"		    ,(MV_ATT_NORM|HAS_60|CARRY_GOLD|CARRY_OBJ|
			     THRO_DR|MV_ATT_NORM),(NONE8),(MF2_EVIL|MF2_GIANT)
			    ,(NONE8),(NONE8)
			    ,60,50,20,45,11,'P',{16,10},{19,19,0,0},14,1,'n'},

{"Flesh golem"		    ,(MV_ATT_NORM),(NONE8),(MF2_IM_ELEC|MF2_CHARM_SLEEP|
                             MF2_MINDLESS),(NONE8),(NONE8)
			    ,50,10,12,30,11,'g',{12,8},{5,5,0,0},14,1,'n'},

{"Warg"			    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL|MF2_EVIL|MF2_GROUP)
			    ,(NONE8),(NONE8)
...
{"Wererat"		    ,(MV_ATT_NORM|CARRY_GOLD|HAS_60|THRO_DR)
			    ...
			    ,(MF2_EVIL|MF2_ANIMAL),(ST_CLOUD),(NONE8)
...
{"Magic mushroom patch"	    ,(MV_ONLY_ATT),(0x1L|BLINK|FEAR|SLOW)
			    ,(MF2_ANIMAL|MF2_GROUP|MF2_CHARM_SLEEP|MF2_MINDLESS),(DARKNESS),(NONE8)
			    ,10,0,40,10,13,',',{1,1},{0,0,0,0},15,2,'n'},

{"Guardian naga"	    ,(HAS_1D2|CARRY_GOLD|CARRY_OBJ|HAS_60|
			     THRO_DR|MV_ATT_NORM|MV_20),(NONE8),(MF2_EVIL),(NONE8)
			     ,(NONE8)
			    ,80,120,20,65,11,'n',{24,11},{77,31,31,0},15,2,'f'},

{"Light hound"		   ,(MV_ATT_NORM),(0x5L),(MF2_ANIMAL|MF2_GROUP),(NONE8)
			    ,(BREATH_LT)
			    ,50,0,30,30,11,'Z',{6,6},{29,0,0,0},15,1,'n'},

{"Dark hound"		  ,(MV_ATT_NORM),(0x5L),(MF2_ANIMAL|MF2_GROUP),(NONE8)
			    ,(BREATH_DA)
			    ,50,0,30,30,11,'Z',{6,6},{29,0,0,0},15,1,'n'},
...
{"Giant tarantula"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_IM_POIS)
			    ,(NONE8),(NONE8)
			    ,70,80,8,32,12,'S',{10,15},{156,156,156,0},15,3,'n'},

{"Giant clear centipede"    ,(MV_INVIS|MV_ATT_NORM),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,30,30,12,30,11,'c',{5,8},{34,62,0,0},15,2,'n'},

{"Mirkwood spider"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_GROUP|MF2_IM_POIS)
			    ,(NONE8),(NONE8)
...
{"Griffon"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Gnome mage"		    ,(CARRY_OBJ|CARRY_GOLD|HAS_60|MV_ATT_NORM|THRO_DR)
			    ,(0x4L|BLINK|FROST_BOLT|MONSTER),(MF2_EVIL|MF2_GROUP)
			    ,(DARKNESS),(NONE8)
			    ,40,20,20,20,11,'h',{7,8},{4,0,0,0},15,2,'m'},

{"Ethereal hound"	    ,(MV_ATT_NORM|MV_INVIS),(NONE8),(MF2_ANIMAL|MF2_GROUP)
			    ,(NONE8),(NONE8)
...
{"Hummerhorn"		    ,(MULTIPLY|MV_ATT_NORM|MV_75),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,4,10,8,14,12,'F',{2,2},{234,0,0,0},16,5,'n'},

{"Ulfast, Son of Ulfang"     ,(HAS_90|CARRY_OBJ|THRO_DR|PICK_UP|
			      MV_ATT_NORM),(NONE8),(MF2_EVIL|MF2_UNIQUE|MF2_GOOD|MF2_MAX_HP)
			     ,(NONE8),(NONE8)
...
{"Forest troll"		    ,(MV_ATT_NORM|THRO_DR|HAS_60|CARRY_GOLD|
			     CARRY_OBJ),(NONE8),(MF2_TROLL|MF2_EVIL|MF2_HURT_LITE|MF2_GROUP)
			    ,(NONE8),(NONE8)
...
{"Giant brown scorpion"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Stone giant"		    ,(MV_ATT_NORM|PICK_UP|THRO_DR|CARRY_GOLD|
			     CARRY_OBJ|HAS_60),(NONE8),(MF2_EVIL|MF2_GIANT)
			    ,(NONE8),(NONE8)
...
{"Giant gold dragon fly"    ,(MV_ATT_NORM|MV_75),(0x9L),
			     (MF2_IM_FIRE|MF2_ANIMAL),(BREATH_SD),(NONE8)
...
{"Sabre-tooth tiger"        ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Chimera"		    ,(MV_ATT_NORM),(0xAL|BREATH_FI),(MF2_IM_FIRE)
			    ,(NONE8),(NONE8)
			    ,200,10,12,15,11,'H',{13,8},{32,105,105,0},20,1,'n'},

{"Quylthulg"		    ,(MV_INVIS),(0x4L|BLINK|MONSTER),(MF2_CHARM_SLEEP|MF2_MINDLESS)
			    ,(NONE8),(NONE8)
			    ,250,0,10,1,11,'Q',{6,8},{0,0,0,0},20,1,'n'},

{"Sasquatch"		    ,(MV_ATT_NORM|THRO_DR),(NONE8),(MF2_ANIMAL|MF2_IM_COLD)
			    ,(NONE8),(NONE8)
...
{"Dark elven lord"	    ,(CARRY_OBJ|HAS_2D2|THRO_DR|MV_ATT_NORM)
			    ...
			    ,(MF2_EVIL|MF2_HURT_LITE),(HASTE|DARKNESS),(NONE8)
...
{"Mimic"                    ,(MV_ONLY_ATT),(0x5L|FIRE_BOLT|CAUSE_SERIOUS|FEAR|
			     BLINDNESS|CONFUSION|MONSTER),(MF2_NO_INFRA|MF2_MINDLESS|
			     MF2_CHARM_SLEEP),(NONE8),(NONE8)
...
{"Killer stag beetle"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
...
{"Giant yellow scorpion"    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8)
			    ,(NONE8)
...
{"Black ooze"		    ,(CARRY_GOLD|CARRY_OBJ|HAS_60|PICK_UP|MULTIPLY|
			    ...
			    ,(0xBL|MANA_DRAIN),(MF2_IM_POIS|MF2_ANIMAL|MF2_MINDLESS),(NONE8)
			    ,(NONE8)
...
{"Killer blue beetle"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL),(NONE8)
			  ,(NONE8),85,30,14,55,11,'K',{20,8},{44,0,0,0},23,1,'n'},

{"Giant bronze dragon fly"  ,(MV_ATT_NORM|MV_75),(0x9L),
			     (MF2_CHARM_SLEEP|MF2_ANIMAL),(BREATH_CO),(NONE8)
...
{"Ibun, Son of Mim"	    ,(MV_ATT_NORM|THRO_DR|CARRY_OBJ|HAS_1D2)
			    ,(0x8L|SLOW|FIRE_BOLT),(MF2_UNIQUE|MF2_IM_COLD|MF2_IM_FIRE|
			     MF2_GOOD|MF2_CHARM_SLEEP|MF2_MAX_HP),(HEAL),(NONE8)
...
{"4-headed hydra"	    ,(MV_ATT_NORM|THRO_DR|CARRY_GOLD|HAS_4D2)
			    ,(0x7L|FEAR),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Sangahyando of Umbar"	    ,(MV_ATT_NORM|CARRY_OBJ|HAS_1D2|HAS_90|THRO_DR)
			    ,(0x4L|SLOW),(MF2_CHARM_SLEEP|MF2_IM_FIRE|MF2_UNIQUE|
			     MF2_IM_ELEC|MF2_GOOD|MF2_MAX_HP),(FORGET),(NONE8)
			,400,25,25,80,11,'p',{80,10},{22,22,22,22},24,2,'m'},

{"Angamaite of Umbar"	    ,(MV_ATT_NORM|CARRY_OBJ|HAS_1D2|HAS_90|THRO_DR)
			    ,(0x4L|SLOW),(MF2_CHARM_SLEEP|MF2_IM_FIRE|MF2_IM_ELEC|
			     MF2_GOOD|MF2_MAX_HP|MF2_UNIQUE),(FORGET),(NONE8)
			,400,25,25,80,11,'p',{80,10},{22,22,22,22},24,2,'m'},
...
{"Dark elven druid"	    ,(MV_ATT_NORM|CARRY_OBJ|HAS_1D2|THRO_DR)
			    ,(0x6L|MONSTER|CONFUSION),(MF2_IM_POIS|
...
{"Wereworm"		    ,(MV_ATT_NORM),(NONE8),(MF2_IM_ACID|MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,300,20,15,70,11,'w',{100,11},{32,139,224,156},
								    25,3,'n'},

{"Carrion crawler"          ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL|MF2_IM_POIS)
                            ,(NONE8),(NONE8)
                            ,60,10,15,40,11,'c',{20,12},{253,253,0,0},25,2,'n'},

{"Killer red beetle"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,85,30,14,50,11,'K',{20,8},{84,0,0,0},25,2,'n'},

{"Giant grey ant lion"	    ,(MV_ATT_NORM|MV_20|THRO_CREAT),(NONE8),(MF2_ANIMAL)
			    ,(NONE8),(NONE8)
			    ,90,40,10,40,11,'a',{19,8},{39,0,0,0},26,1,'n'},

{"Ulwarth, Son of Ulfang"      ,(HAS_90|CARRY_OBJ|THRO_DR|PICK_UP|
			      MV_ATT_NORM),(NONE8),(MF2_EVIL|MF2_UNIQUE|MF2_GOOD)
			    ,(NONE8),(NONE8)
			    ,500,40,20,40,11,'p',{80,11},{22,22,22,0},26,4,'m'},

{"Displacer beast"          ,(MV_ATT_NORM|MV_INVIS),(NONE8),(MF2_ANIMAL)
                            ,(NONE8),(NONE8)
			    ,100,20,35,100,11,'f',{25,10},{37,9,9,9},26,2,'n'},

{"Giant fire tick"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL|MF2_IM_FIRE)
			    ,(NONE8),(NONE8)
...
{"White wraith"		    ,(CARRY_GOLD|CARRY_OBJ|HAS_1D2|THRO_DR|
			    ...
			    ,(MF2_UNDEAD|MF2_EVIL|MF2_NO_INFRA|MF2_IM_COLD|MF2_IM_POIS|
			      MF2_CHARM_SLEEP|MF2_HURT_LITE),(DARKNESS),(NONE8)
...
{"Mim, Betrayer of Turin"   ,(MV_ATT_NORM|THRO_DR|CARRY_OBJ|HAS_2D2)
			    ,(0x6L|FEAR|ACID_BOLT),(MF2_EVIL|MF2_MAX_HP|MF2_IM_COLD|
			     MF2_IM_FIRE|MF2_IM_POIS|MF2_IM_ACID|MF2_IM_ELEC|MF2_UNIQUE|
			     MF2_GOOD|MF2_CHARM_SLEEP),(ACID_BALL|HEAL),(NONE8)
			    ,1000,20,20,80,12,'h',{100,11},{20,20,20,204},27,4,'m'},

{"Killer fire beetle"	    ,(MV_ATT_NORM),(NONE8),(MF2_IM_FIRE|MF2_ANIMAL)
			    ,(NONE8),(NONE8)
...
{"Ogre mage"		,(CARRY_GOLD|CARRY_OBJ|HAS_1D2|THRO_DR|MV_ATT_NORM)
			    ...
			    ,(MF2_EVIL|MF2_GIANT),(HEAL|TRAP_CREATE),(NONE8)
...
{"Gorgimera"		    ,(MV_ATT_NORM),(0x8L|BREATH_FI),(MF2_IM_FIRE)
			    ,(NONE8),(NONE8)
...
{"Black knight"		   ,(HAS_1D2|CARRY_OBJ|THRO_DR|MV_ATT_NORM|CARRY_GOLD)
			    ,(0x8L|CAUSE_CRIT|BLINDNESS|FEAR),(MF2_EVIL)
			    ,(DARKNESS),(NONE8)
...
{"Mage"			    ,(HAS_1D2|CARRY_OBJ|THRO_DR|MV_ATT_NORM)
			    ,(0x3L|TELE|TELE_TO|BLINDNESS|FROST_BOLT|FIRE_BOLT
			     |CONFUSION|MONSTER),(MF2_EVIL|MF2_INTELLIGENT)
...
{"Giant purple worm"	    ,(MV_ATT_NORM),(NONE8),(MF2_IM_ACID|MF2_ANIMAL)
			    ,(NONE8),(NONE8)
...
{"Mimic"                    ,(MV_ONLY_ATT),(0x4L|FEAR|CONFUSION|BLINDNESS|
			     ...
			     MONSTER),(MF2_CHARM_SLEEP|MF2_NO_INFRA|MF2_MINDLESS),
                             (LIGHT_BOLT|FORGET),(NONE8)
...
{"Manticore"		    ,(MV_ATT_NORM),(0x5L),(MF2_EVIL|MF2_MAX_HP),(MISSILE)
			    ,(NONE8)
			    ,300,10,12,15,12,'H',{25,10},{17,17,17,17},30,2,'n'},

{"Giant static ant"	    ,(MV_ATT_NORM|MV_20),(NONE8),(MF2_ANIMAL|MF2_IM_ELEC)
			    ,(NONE8),(NONE8)
...
{"Grave wight"		    ,(MV_ATT_NORM|MV_20|THRO_DR|HAS_1D2|CARRY_OBJ)
			    ...
			    ,(MF2_UNDEAD|MF2_EVIL|MF2_NO_INFRA|MF2_IM_COLD|MF2_IM_POIS|
			      MF2_HURT_LITE|MF2_CHARM_SLEEP),(DARKNESS),(NONE8)
			    ,325,30,20,50,11,'W',{12,10},{6,6,191,0},30,1,'n'},

{"Killer slicer beetle"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Death watch beetle"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Ogre shaman"		    ,(MV_ATT_NORM|THRO_DR|HAS_90|CARRY_OBJ)
			    ,(0x5L|TELE|HOLD_PERSON|CAUSE_SERIOUS|
			     FEAR|MONSTER|FIRE_BOLT),(MF2_EVIL|MF2_GIANT)
			    ,(TRAP_CREATE),(NONE8)
			    ,250,30,20,55,11,'O',{14,10},{19,19,19,0},32,2,'n'},

{"Nexus quylthulg"	    ,(MV_INVIS),(0x1L|BLINK),(MF2_CHARM_SLEEP|MF2_MINDLESS)
			    ,(TELE_AWAY),(NONE8)
...
{"Shelob, Spider of Darkness",(MV_ATT_NORM|CARRY_OBJ|HAS_2D2|HAS_1D2)
			   ,(0x2L|FEAR|BLINDNESS|CONFUSION|SLOW|CAUSE_CRIT)
			     ...
			     MF2_MAX_HP|MF2_GOOD|MF2_INTELLIGENT),(RAZOR|HEAL|S_SPIDER|
			     TRAP_CREATE),(NONE8)
...
{"Memory moss"              ,(MV_ONLY_ATT),(0x6L),(MF2_CHARM_SLEEP|MF2_ANIMAL|MF2_MINDLESS)
                            ,(FORGET),(NONE8)
...
{"Barrow wight"		    ,(MV_ATT_NORM|THRO_DR|CARRY_OBJ|
			    ...
			    ,(MF2_EVIL|MF2_UNDEAD|MF2_NO_INFRA|MF2_IM_COLD|MF2_IM_POIS|
			      MF2_HURT_LITE|MF2_CHARM_SLEEP|MF2_GROUP),(DARKNESS),(NONE8)
...
{"Chaos drake"		    ,(MV_ATT_NORM|THRO_DR|HAS_2D2|CARRY_OBJ)
			    ,(0x6L|FEAR|CONFUSION|SLOW),(MF2_EVIL|MF2_IM_FIRE|
			     MF2_CHARM_SLEEP|MF2_MAX_HP|MF2_DRAGON),(BREATH_DI)
			    ,(NONE8)
			  ,700,30,25,100,11,'d',{50,10},{54,54,36,0},33,3,'n'},

{"Law drake"		    ,(MV_ATT_NORM|THRO_DR|HAS_2D2|CARRY_OBJ)
			    ,(0x6L|FEAR|CONFUSION|SLOW),(MF2_EVIL|MF2_IM_COLD|
			     MF2_CHARM_SLEEP|MF2_MAX_HP|MF2_DRAGON),(BREATH_SH|
			     BREATH_SD),(NONE8)
...
{"Giant red scorpion"	    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Ooze elemental"	    ,(MV_ATT_NORM|THRO_DR)
		      ...
		      MF2_CHARM_SLEEP|MF2_EVIL|MF2_NO_INFRA|MF2_MINDLESS),(ACID_BALL),(NONE8)
			  ,300,90,10,80,11,'E',{13,10},{115,115,115,0},35,3,'n'},

{"Smoke elemental"	    ,(MV_ATT_NORM)
			    ,(0x5L|FIRE_BOLT)
			    ,(MF2_IM_POIS|MF2_IM_FIRE|MF2_IM_COLD|MF2_IM_ELEC|MF2_MINDLESS|
			      MF2_CHARM_SLEEP|MF2_EVIL),(DARKNESS),(NONE8)
...
{"Mumak"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL),(NONE8),(NONE8)
...
{"Shadow"		    ,(MV_ATT_NORM|THRO_WALL|MV_INVIS|CARRY_OBJ|
			     HAS_1D2),(0x8L|TELE_TO|SLOW),(MF2_UNDEAD|MF2_EVIL|
...
{"Phantom"		    ,(MV_ATT_NORM|THRO_WALL|MV_INVIS|CARRY_OBJ|
			     HAS_1D2),(0x5L),(MF2_UNDEAD|MF2_EVIL|MF2_IM_COLD|MF2_IM_POIS|
			     MF2_NO_INFRA|MF2_CHARM_SLEEP),(FORGET),(NONE8)
...
{"Colossus"		    ,(MV_ATT_NORM),(NONE8),(MF2_MAX_HP|MF2_CHARM_SLEEP|MF2_MINDLESS|
...
{"Ice elemental"	    ,(PICK_UP|MV_ATT_NORM)
			    ...
			    ,(MF2_IM_POIS|MF2_IM_COLD|MF2_IM_ELEC|MF2_MINDLESS|
			     MF2_CHARM_SLEEP|MF2_EVIL|MF2_NO_INFRA),(ICE_BOLT),(NONE8)
...
{"Necromancer"		    ,(MV_ATT_NORM|THRO_DR|CARRY_OBJ|HAS_1D2)
			   ...
			   S_UNDEAD|FEAR|BLINDNESS),(MF2_EVIL|MF2_MAX_HP|MF2_INTELLIGENT)
...
{"Magma elemental"	    ,(THRO_WALL|PICK_UP|MV_ATT_NORM)
			    ...
			    ,(MF2_IM_POIS|MF2_IM_FIRE|MF2_IM_ELEC|MF2_MINDLESS|
			      MF2_CHARM_SLEEP|MF2_EVIL),(PLASMA_BOLT),(NONE8)
...
{"Nexus vortex"		    ,(MV_ATT_NORM|MV_75),(0x6L)
			    ,(MF2_CHARM_SLEEP|MF2_MINDLESS),(BREATH_NE),(NONE8)
			    ,800,0,100,40,12,'v',{32,10},{244,0,0,0},37,1,'n'},

{"Plasma vortex"	    ,(MV_ATT_NORM|MV_75),(0x6L)
			    ,(MF2_IM_FIRE|MF2_CHARM_SLEEP|MF2_MINDLESS),(NONE8),(BREATH_PL)
...
{"Time vortex"		    ,(MV_ATT_NORM|MV_75),(0x6L)
			    ,(MF2_CHARM_SLEEP|MF2_MINDLESS),(NONE8),(BREATH_TI)
			    ,900,0,100,40,13,'v',{32,10},{244,0,0,0},38,4,'n'},

{"Shimmering vortex"	    ,(MV_ATT_NORM|MV_75),(0x6L)
			    ,(MF2_CHARM_SLEEP|MF2_MINDLESS),(NONE8),(BREATH_LT)
...
{"Ancient bronze dragon"    ,(HAS_4D2|CARRY_GOLD|CARRY_OBJ|HAS_90|HAS_2D2|
			    ...
			    ,(MF2_DRAGON|MF2_CHARM_SLEEP|MF2_MAX_HP),(BREATH_CO),(NONE8)
...
{"Disenchanter worms"	    ,(MULTIPLY|MV_ATT_NORM|MV_40),(NONE8),
			     (MF2_ANIMAL|MF2_HURT_LITE|MF2_MINDLESS),(NONE8),(NONE8)
			    ,30,10,7,5,10,'w',{10,8},{208,0,0,0},40,3,'p'},

{"Rotting quylthulg"	    ,(MV_INVIS)
			    ,(0x2L|S_UNDEAD|BLINK|TELE), (MF2_ANIMAL|MF2_EVIL|MF2_MAX_HP|
...
{"Sorceror"		    ,(HAS_4D2|CARRY_OBJ|HAS_90|THRO_DR|MV_ATT_NORM)
			    ...
			    ,(MF2_EVIL|MF2_CHARM_SLEEP|MF2_MAX_HP),(TRAP_CREATE),(NONE8)
...
{"Giant roc"                ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_IM_ELEC)
                            ,(NONE8),(NONE8)
...
{"Minotaur"		    ,(MV_ATT_NORM),(NONE8),(MF2_EVIL),(NONE8),(NONE8)
...
{"Ancient gold dragon"	    ,(HAS_4D2|CARRY_GOLD|CARRY_OBJ|HAS_90|HAS_2D2|
			      HAS_60|MV_ATT_NORM)
			    ,(0x6L|FEAR|BLINDNESS|CONFUSION)
			    ,(MF2_DRAGON|MF2_CHARM_SLEEP|MF2_MAX_HP),(BREATH_SD),(NONE8)
...
{"Mumak"		    ,(MV_ATT_NORM),(NONE8),(MF2_ANIMAL|MF2_GROUP)
			    ,(NONE8),(NONE8)
...
{"Quaker, Master of Earth"  ,(THRO_WALL|PICK_UP|MV_ATT_NORM),(0x6L|ACID_BOLT)
			    ,(MF2_IM_POIS|MF2_IM_FIRE|MF2_IM_COLD|MF2_IM_ELEC|
			      ...
			      MF2_DESTRUCT|MF2_UNIQUE),(ACID_BALL),(NONE8)
...
{"Ariel, Queen of Air"	    ,(MV_ATT_NORM|MV_20|THRO_CREAT),(0x5L|FROST_BALL)
			    ,(MF2_EVIL|MF2_IM_POIS|MF2_CHARM_SLEEP|MF2_IM_FIRE|MF2_IM_COLD|
			      ...
			      MF2_NO_INFRA),(LIGHT_BALL|LIGHT_BOLT),(NONE8)
...
{"11-headed hydra"	    ,(MV_ATT_NORM|THRO_DR|CARRY_GOLD|HAS_4D2|HAS_2D2)
			    ...
			    ,(MF2_ANIMAL|MF2_IM_FIRE),(PLASMA_BOLT),(NONE8)
...
{"Dwar, Dog Lord of Waw"    ,(HAS_4D2|CARRY_OBJ|THRO_DR|MV_ATT_NORM)
			    ...
			    ,(MF2_EVIL|MF2_UNDEAD|MF2_CHARM_SLEEP|MF2_IM_COLD|MF2_MAX_HP|MF2_UNIQUE
			     ...
			     MF2_NO_INFRA),(NETHER_BALL|SUMMON|S_HOUND),(NONE8)
...
{"Dracolisk"		    ,(MV_ATT_NORM|THRO_DR|HAS_4D2|CARRY_OBJ)
			    ...
			    ,(MF2_ANIMAL|MF2_EVIL|MF2_CHARM_SLEEP|MF2_MAX_HP|MF2_DRAGON|MF2_IM_FIRE|
			     MF2_IM_ACID),(BREATH_NE),(NONE8)
			,14000,30,25,120,12,'H',{70,50},{39,39,48,146},46,2,'n'},

{"Death mold"		    ,(MV_ONLY_ATT),(NONE8),(MF2_IM_FIRE|MF2_IM_POIS|MF2_MINDLESS|
...
{"Nether hound"		    ,(MV_ATT_NORM|THRO_DR),(0x5L)
			    ,(MF2_ANIMAL|MF2_GROUP|MF2_CHARM_SLEEP),(BREATH_LD)
			    ,(NONE8)
...
{"Baphomet the Minotaur Lord" ,(HAS_4D2|HAS_1D2|CARRY_OBJ|MV_ATT_NORM)
			    ,(0x6L|SLOW|MANA_BOLT),(MF2_EVIL|MF2_CHARM_SLEEP|MF2_UNIQUE|
			     MF2_MAX_HP|MF2_GOOD|MF2_IM_POIS|MF2_IM_FIRE),(PLASMA_BOLT|
...
{"Harowen the Black Hand"   ,(HAS_4D2|HAS_1D2|CARRY_OBJ|MV_ATT_NORM)
			    ,(0x6L),(MF2_CHARM_SLEEP|MF2_MAX_HP|MF2_UNIQUE|
			     MF2_GOOD|MF2_IM_POIS),(TRAP_CREATE),(NONE8)
...
{"Hoarmurath of Dir",	(HAS_4D2|HAS_2D2|CARRY_OBJ|THRO_DR|MV_ATT_NORM)
			    ...
			    ,(MF2_EVIL|MF2_UNDEAD|MF2_CHARM_SLEEP|MF2_IM_COLD|MF2_MAX_HP|MF2_UNIQUE
			     ...
			     MF2_NO_INFRA),(RAZOR|NETHER_BALL|MIND_BLAST),(NONE8)
...
{"The Phoenix"          ,(MV_ATT_NORM|THRO_DR|CARRY_OBJ|HAS_2D2)
			...
			,(MF2_ANIMAL|MF2_CHARM_SLEEP|MF2_IM_FIRE|MF2_IM_ELEC|MF2_IM_POIS|
			 MF2_IM_ACID|MF2_GOOD|MF2_UNIQUE|MF2_MAX_HP),(PLASMA_BOLT)
			,(BREATH_LT|BREATH_PL)
...
{"Nightcrawler"		,(MV_ATT_NORM|HAS_2D2|CARRY_OBJ|HAS_1D2|THRO_DR)
			...
			,(MF2_EVIL|MF2_UNDEAD|MF2_IM_COLD|MF2_IM_POIS|MF2_IM_FIRE|MF2_CHARM_SLEEP|
			 MF2_INTELLIGENT|MF2_GOOD|MF2_NO_INFRA),(BRAIN_SMASH|NETHER_BALL|
...
{"Chaos vortex"		     ,(MV_ATT_NORM|MV_75),(0x6L)
			    ,(MF2_CHARM_SLEEP|MF2_MINDLESS),(BREATH_CH),(NONE8)
...
{"Thuringwethil"	    ,(MV_ATT_NORM|THRO_DR|HAS_4D2|HAS_2D2|HAS_1D2|
			    ...
			    MF2_IM_POIS),(NETHER_BALL|RAZOR|BRAIN_SMASH),(NONE8)
...
{"Draconic quylthulg"	     ,(MV_INVIS)
			    ,(0x2L|S_DRAGON|BLINK|TELE),(MF2_MAX_HP|MF2_ANIMAL|MF2_EVIL|MF2_MINDLESS
			     |MF2_CHARM_SLEEP),(NONE8),(NONE8)
...
{"Fundin Bluecloak"	    ,(HAS_4D2|CARRY_OBJ|HAS_1D2|MV_ATT_NORM|THRO_DR)
			    ...
			    ,(MF2_CHARM_SLEEP|MF2_MAX_HP|MF2_GOOD|MF2_IM_POIS|MF2_IM_COLD|
			     MF2_IM_FIRE|MF2_IM_ACID|MF2_IM_ELEC|MF2_UNIQUE),(FORGET|
...
{"Jabberwock"		    ,(CARRY_OBJ|HAS_90|HAS_60|MV_ATT_NORM)
			    ,(0x5L)
			    ,(MF2_ANIMAL|MF2_MAX_HP),(BREATH_CH|RAZOR)
			    ,(NONE8)
			   ,19000,255,35,125,13,'J',{80,40},{212,212,212,212},
			     65,4,'n'},

{"Chaos hound"		    ,(MV_ATT_NORM),(0x5L)
			    ,(MF2_ANIMAL|MF2_GROUP|MF2_CHARM_SLEEP),(BREATH_CH)
			    ,(NONE8)
...
{"Great Wyrm of Chaos"	    ,(HAS_1D2|HAS_4D2|HAS_2D2|CARRY_OBJ|HAS_90|HAS_60|
			     ...
			     S_DRAGON),(MF2_EVIL|MF2_DRAGON|MF2_CHARM_SLEEP|MF2_MAX_HP|MF2_GOOD)
...
{"Great Wyrm of Law"	    ,(HAS_1D2|HAS_4D2|HAS_2D2|CARRY_OBJ|HAS_90|HAS_60|
			      MV_ATT_NORM),(0x3L|FEAR|BLINDNESS|CONFUSION|
			     S_DRAGON),(MF2_DRAGON|MF2_CHARM_SLEEP|MF2_MAX_HP|MF2_GOOD)
...
{"Tiamat, Celestial Dragon of Evil",(MV_ATT_NORM|HAS_4D2|CARRY_OBJ|
			    ...
			    ,(MF2_IM_COLD|MF2_IM_ACID|MF2_IM_POIS|MF2_IM_ELEC|
			      MF2_IM_FIRE|MF2_EVIL|MF2_DRAGON|MF2_CHARM_SLEEP|MF2_MAX_HP|
			      MF2_UNIQUE|MF2_SPECIAL),(NONE8),(S_ANCIENTD)
...
{"Master quylthulg"	    ,(MV_INVIS)
			,(0x2L|MONSTER|S_UNDEAD|S_DRAGON),(MF2_CHARM_SLEEP|MF2_MINDLESS|
			  MF2_ANIMAL|MF2_MAX_HP|MF2_EVIL),(SUMMON),(S_GUNDEAD|S_ANCIENTD)
		       ,12000,0,20,1,12,'Q',{100,20},{0,0,0,0},71,3,'n'},

{"Greater draconic quylthulg" ,(MV_INVIS)
			    ,(0x2L|BLINK|TELE_TO),(MF2_ANIMAL|MF2_EVIL|MF2_MAX_HP|MF2_MINDLESS|
			     MF2_CHARM_SLEEP) ,(NONE8),(S_ANCIENTD)
			,10500,0,20,1,12,'Q',{100,14},{0,0,0,0},71,3,'n'},

{"Greater rotting quylthulg",(MV_INVIS)
			    ,(0x2L|BLINK|TELE_TO),(MF2_ANIMAL|MF2_EVIL|MF2_MINDLESS|
			     MF2_CHARM_SLEEP|MF2_MAX_HP),(NONE8),(S_GUNDEAD)
			,10500,0,20,1,12,'Q',{100,14},{0,0,0,0},71,3,'n'},
...
{"The Mouth of Sauron"	    ,(MV_ATT_NORM|MV_INVIS|THRO_DR|HAS_4D2|HAS_1D2|
			     ...
			     HOLD_PERSON),(MF2_EVIL|MF2_MAX_HP|MF2_UNIQUE|MF2_GOOD|MF2_CHARM_SLEEP
...
{"Pazuzu, Lord of Air"     ,(MV_ATT_NORM|THRO_DR|MV_INVIS|CARRY_OBJ|HAS_4D2)
                           ,(0x3L|MANA_BOLT),(MF2_EVIL|MF2_DEMON|MF2_CHARM_SLEEP|
			    MF2_MAX_HP|MF2_IM_COLD|MF2_IM_FIRE|MF2_IM_ELEC|MF2_IM_ACID|
			    MF2_IM_POIS|MF2_GOOD|MF2_UNIQUE),(LIGHT_BOLT|LIGHT_BALL|
			    MIND_BLAST),(NONE8)
...
{"Lungorthin, the Balrog of White Fire",
			     (MV_ATT_NORM|HAS_4D2|HAS_2D2|HAS_1D2|
                            ...
                            ,(0x4L|FEAR|BLINDNESS|S_DEMON|
                      	      BREATH_FI|CONFUSION)
                            ,(MF2_EVIL|MF2_DEMON|MF2_CHARM_SLEEP|MF2_IM_FIRE|MF2_MAX_HP|
			      MF2_UNIQUE|MF2_GOOD),(NONE8),(S_GUNDEAD)
...
{"Cerberus, Guardian of Hades",(MV_ATT_NORM|HAS_4D2|CARRY_OBJ|THRO_DR)
			    ,(0x3L|BREATH_FI),(MF2_ANIMAL|MF2_EVIL|MF2_UNIQUE|MF2_IM_FIRE|
			     MF2_MAX_HP|MF2_GOOD|MF2_CHARM_SLEEP)
